...
def main():
    st.title("Halaman Topic Modelling")
    st.write("""
            Topic Modelling adalah salah satu teknik dalam text mining yang digunakan untuk mengidentifikasi dan mengelompokkan kata-kata atau frasa dalam sebuah koleksi teks ke dalam kelompok-kelompok yang memiliki topik atau tema yang serupa. Tujuan utama dari topic modeling adalah untuk mengungkapkan pola dan struktur yang tersembunyi dalam teks yang besar dan kompleks. 
        """)
